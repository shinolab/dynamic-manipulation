...
{
    NP_PARAM_TRACKING,          // read-only
    NP_PARAM_PAUSED,            // read-only
    NP_PARAM_CENTERED,          // TrackIR app sets this flag, client can read and clear once handled
